...
train_loader = DataLoader(train_dataset, shuffle=True, batch_size=minibatch_size, num_workers=num_workers, drop_last=True)
...
validation_loader = DataLoader(validation_dataset, shuffle=True, batch_size=minibatch_size, num_workers=num_workers, drop_last=True)
