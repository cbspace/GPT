...
train_dataset = load_dataset('skymizer/fineweb-edu-dedup-45B', 'default', split='train[:200000]') #500000
valid_dataset = load_dataset('skymizer/fineweb-edu-dedup-45B', 'default', split='train[200000:220000]')
...
create_token_file(train_dataset, 'train_dataset_fine_medium')
create_token_file(valid_dataset, 'validation_dataset_fine_medium')